...
\section{Räume}
\begin{frame}{Seminarräume: Bevorzugt}
...
\begin{frame}{Seminarräume: Weitere}
  \begin{columns}[onlytextwidth]
    \begin{column}{0.3\textwidth}
      \begin{itemize}
        \item<1-> EW 431
  ...
  \begin{columns}[onlytextwidth]
    \begin{column}{0.3\textwidth}
      \begin{itemize}
        ...
        \item<2-> EW 183 $\Rightarrow  \mbox{m}^{2}$
        \item<3-> EW 184 $\Rightarrow 43,43 \mbox{m}^{2}$
        \item<4-> EW 209 $\Rightarrow 33,44 \mbox{m}^{2}$
        \item<5-> EW 217 $\Rightarrow 51,59 \mbox{m}^{2}$
      \end{itemize}
    \end{column}
    \begin{column}{0.7\textwidth}
      % hier wird für jede Raumnummer das entsprechende Bild angezeigt.
...
\begin{frame}{Weitere Räume, deren Endnutzung noch nicht feststeht}
  \begin{columns}[onlytextwidth]
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        \item<1-> PL-Tutor*innenraum
        \item<2-> GP-Tutor*innenraum
        \item<3-> Atomic und Ini
        \item<4-> PC-Pool
        \item<5-> MuLF
      \end{itemize}
    \end{column}
